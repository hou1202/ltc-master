...
//------------------------------------------------------用户体系
    ...
    {
        $this->client_id = ThinkConfig::get('client_id');
        $this->client_secret = ThinkConfig::get('client_secret');
        $this->org_name = ThinkConfig::get('org_name');
        $this->app_name = ThinkConfig::get('app_name');
    ...
    */
    ...
    function postCurl($url, $body, $header, $type = "POST")
    {
        ...
        //2)设备请求体
        if(is_string($body) && mb_strlen($body)>0){
