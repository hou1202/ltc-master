...
class BankSearch
{
    public static $bankBin = array(
        ...
        623251, 628351, 627066,627066,627067,627068,627069,412962,412963,415752,415753,622535,622536,
        622538,622539,622983,998800,623668);
// "发卡行.卡种名称",
    public static $bankName = array(
        ...
        "玉溪市商业银行·红塔卡" ,"平安银行","平安银行","平安银行","平安银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","深圳发展银行","建设银行 - 借记卡");

    public static function getname($cardnumber) {

        $charBin = substr($cardnumber, 0,6); //cardnumber.substring(0, 6);
        $index= array_search($charBin, self::$bankBin); //binarySearch(bankBin, bin);

        if ($index == -1 ||  $index> count( self::$bankName) ||!$index ){
            return null;
        }
