...
var WritingPad = function () {
    ...
    $(function () {
        ...
        $(document).on("click", "#mySave", null, function () {
            ...
            //$(myImg).append(img);
            ajaxPostCommonJump('/index/user/setSign.html', {sign:dataUrl})
        ...
        $(document).on("click", "#myColor", null, function () {
            $('#colorpanel').css('left', '530px').css('top', '-200px').css("display", "block").fadeIn();
            ...
            '<div class="modal-dialog">' +
                '<div class="modal-content">' +
                    '<div class="modal-header">' +
                        '' +
                        '<div class="modal-title" style="text-align:center;padding:10px 0;">在以下空白处写下你的签名</div>' +
                    '</div>' +
    ...
    function initSignature() {
        ...
        if (window.requestAnimFrame) {
            ...
            signature.jqSignature({ width: 500, height: 200, border: '1px solid #999', background: '#fff', lineColor: '#000000', lineWidth: 2, autoFit: false });
