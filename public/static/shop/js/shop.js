                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.code == 1) {
                            ...
                            window.location.href = '/shop/login/index';
                        } else {
...
function lock($, layer) {
    ...
    layer.open({
        ...
        success: function (layero, lockIndex) {
            ...
            $.post('/shop/login/logout', function (data) {
                //验证成功
                if (data.code == 1) {
            ...
            var unlock = function (un, pwd) {
                //这里可以使用ajax方法解锁
                $.post('/shop/login/login', {username: un, password: pwd}, function (data) {
                    //验证成功
                    if (data.code == 1) {
                        //关闭锁屏层
